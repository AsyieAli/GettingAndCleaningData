##Read Dataset Online.
websiteFile <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
##download the file.
download.file(websiteFile, "./UCI-HAR-dataset.zip", method="auto")
